    ...
    <script type="text/javascript">
        ...
        KindEditor.ready(function (K) {
            ...
            window.editor = K.create('#editor_id', {
                uploadJson: '${pageContext.request.contextPath}/article/articleUpload',
    ...
    <div class="container-fluid">
        ...
        <div>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a>欢迎:<font style="color: #b92c28;font-size:30px">${sessionScope.admin.username}</font></a></li>
                ...
                <div class="panel panel-success">
                    ...
                    <div id="collapseSix" class="panel-collapse collapse">
                        <div class="panel-body">
                            <ul class="nav">
                                <li>
                                    <a href="javascript:$('#centerLay').load('./chat.jsp')">进入聊天室</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div id="myCarousel" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="${pageContext.request.contextPath}/img/timg.jpg" alt="First slide" width="800px"
                                 height="683px">
                            <div class="carousel-caption">标题 1</div>
                        </div>
                        <div class="item">
                            <img src="${pageContext.request.contextPath}/img/ff.jpg" alt="Second slide" width="800px"
                                 height="690px">
                            <div class="carousel-caption">标题 2</div>
                        </div>
                        <div class="item">
                            <img src="${pageContext.request.contextPath}/img/dd.jpg" alt="Third slide" width="800px"
                                 height="683px">
...
&lt;strong&gt;HTML内容&lt;/strong&gt;
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal" id="closeId">关闭</button>
